 ...
 * The Class LwwString.
 */
public class LwwString extends PrimitiveType{
	 ...
	 * @param v the v
	 */
	public LwwString(String dataName, String v){
		super(dataName);
		this.value = v;
	}
	 ...
	 * @param ts the ts
	 */
	public LwwString(String dataName, String v, LwwLogicalTimestamp ts){
		super(dataName);
		this.value = v;
	 ...
	 * @param lts the lts
	 */
	public void update(String v, LwwLogicalTimestamp lts){
	...
	public String toString() {
		String str = "LwwString" + " value " + this.value;
		return str;
	}
