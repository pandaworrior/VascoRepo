 ...
 * The Class LwwLong.
 */
public class LwwLong extends PrimitiveType{
	 ...
	 * @param v the v
	 */
	public LwwLong(String dataName, long v){
		super(dataName);
		this.value = v;
	}
	 ...
	 * @param ts the ts
	 */
	public LwwLong(String dataName, long v, LwwLogicalTimestamp ts){
		super(dataName);
		this.value = v;
	...
	public String toString() {
		String str = "LwwLong" + " value " + this.value;
		return str;
	}
