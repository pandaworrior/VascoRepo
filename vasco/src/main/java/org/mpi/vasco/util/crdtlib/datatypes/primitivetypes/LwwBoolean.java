 ...
 */
public class LwwBoolean extends PrimitiveType{
	 ...
	 * @param v the v
	 */
	public LwwBoolean(String dataName, boolean v){
		super(dataName);
		this.value = v;
	}
	 ...
	 * @param ts the ts
	 */
	public LwwBoolean(String dataName, boolean v, LwwLogicalTimestamp ts){
		super(dataName);
		this.value = v;
	 ...
	 * @param lts the lts
	 */
	public void update(boolean v, LwwLogicalTimestamp lts){
	...
	public String toString() {
		String str = "LwwInteger" + " value " + this.value;
		return str;
	}
