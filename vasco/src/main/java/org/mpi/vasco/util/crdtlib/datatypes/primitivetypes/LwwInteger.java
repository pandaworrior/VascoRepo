 ...
 */
public class LwwInteger extends PrimitiveType{
	 ...
	 * @param v the v
	 */
	public LwwInteger(String dataName, long v){
		super(dataName);
		this.value = v;
	}
	 ...
	 * @param ts the ts
	 */
	public LwwInteger(String dataName, long v, LwwLogicalTimestamp ts){
		super(dataName);
		this.value = v;
	 ...
	 * @param lts the lts
	 */
	public void update(long v, LwwLogicalTimestamp lts){
