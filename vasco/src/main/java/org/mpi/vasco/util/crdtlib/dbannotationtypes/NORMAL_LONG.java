 ...
 * The Class LWW_LONG.
 */
public class NORMAL_LONG extends DataField {
	 ...
	 */
	public NORMAL_LONG(String dFN, String tN, String dT, boolean iPK,
			boolean iFK, boolean iAIC, int position) {
		super(CrdtDataFieldType.NORMALLONG, dFN, tN, dT, iPK, iFK, iAIC,
				position);
