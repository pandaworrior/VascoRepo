...
/**
 * The Class UniqueInsertOperation.
 */
public class UniqueInsertOperation extends Operation{

	/**
	 * Instantiates a new unique insert operation.
	 *
	 * @param tN the t n
	 * @param dT the d t
	 */
	public UniqueInsertOperation(String tN, DatabaseTable dT) {
		super(tN, dT);
	...
	public String getOperationFingerPrint() {
		String identifierStr = super.getTableName() + "." + DatabaseDef.UNIQUE_INSERT_OP_STR;
		try {
